(() => {
  ...
  const STEPS = [
    ...
    system("リハスの必殺技は周囲の魔物を挑発することができます", { highlightUltimateUnitId: "rihas" }),
    ...
    system("逆に調子が低すぎると魔物から逃げてしまったり、攻撃が疎かになります", { highlightStatusUnitId: "sushia" }),
    system("調子は魔物を攻撃したり、回復を受けすぎたりすると上昇します", { highlightStatusUnitId: "sushia" }),
    system("魔物からダメージを受けたり、HPをある程度低く保ってあげると調子を下げることができます", { highlightStatusUnitId: "sushia" }),
    ...
    system("ウルペスの必殺技は魔物1体に大ダメージを与えることができます！", { highlightUltimateUnitId: "ulpes" }),
    waitUltimate("ulpesUltimate", "ulpes", "最後の魔物にとどめを刺しましょう！"),
    line("ウルペス", "真っ二つ！！"),
