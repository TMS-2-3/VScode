(() => {
  ...
  window.HEALER_SKILL_DATA = {
    ...
    rihas: {
      attack: {
        id: "daiti_punch", key: "attack", owner: "rihas", name: "振り払い", rank: "D", category: "通常攻撃",
      ...
      quake: {
        id: "daiti_wave", key: "quake", owner: "rihas", name: "台地よ!揺れよ!", rank: "D", category: "スキル",
        cd: 13, cost: 15, range: px(260), radius: px(90), shockRadius: px(180), cast: 1, landingOffset: px(18), damageBase: 22, attackScale: 0.8, shockDamageBase: 10, shockMagicScale: 0.2, burstRadius: px(170), approach: true, lines: ["台地よ!揺れよ!"], damageType: "mixed",
        formula: [
    ...
    sushia: {
      ...
      chacka: {
        id: "chacka", key: "chacka", owner: "sushia", name: "チャッカ", rank: "D", category: "スキル",
        cd: 8, cost: 15, range: px(450), cast: 1, damageBase: 10, magicScale: 0.15, burnDuration: 4, burnDamageHpRatio: 0.01, burnTickRate: 1, burnDefensePenalty: -0.1, beamColor: "rgba(255,139,67,0.74)", burstRadius: px(44), lines: ["チャッカ"], damageType: "magic", statusIds: ["debuff_burn"],
        formula: [{ text: "10 + 魔力 * 0.15", stat: "magic", baseProp: "damageBase", scaleProp: "magicScale" }],
        description: "１秒の詠唱を行った後、対象の敵１体に(式=値)の魔法ダメージを与え、４秒の\"燃焼\"を付与する。",
        simpleDescription: "詠唱後、対象の敵１体に(式=値)の魔法ダメージを与え、\"燃焼\"を付与する。",
  ...
  window.HEALER_PASSIVE_DATA = {
    finald: {
      hilment: { id: "hilment_passive", key: "hilment", owner: "finald", name: "ヒルメント", selfHealRatio: 0.3, description: "味方に与えた回復効果の30%分、自身の体力を回復する。味方の体力を超過した回復効果はこの効果に含まれない。" },
    },
    ulpes: {
      swordwork: { id: "hero_critical_passive", key: "swordwork", owner: "ulpes", name: "慣れた剣捌き", description: "会心率が2倍になる。代わりに会心ダメージが半分減少する。" },
    },
    rihas: {
      painless: { id: "damage_dot_passive", key: "painless", owner: "rihas", name: "痛みなし", statusIds: ["buff_itaminasi"], description: "受けるダメージの1/3を5分割にし、1秒ごとの遅延ダメージで受ける。遅延ダメージは最低1ダメージ。HPが減るたびに３秒間持続する\"逆境\"を１スタック獲得する。" },
    },
    sushia: {
      warmup: { id: "warmup_passive", key: "warmup", owner: "sushia", name: "あったまってきたよ！", statusIds: ["buff_warmup"], description: "敵に魔法ダメージを与えるたびに８秒間持続する\"ウォームアップ\"を１スタック獲得する。" },
    },
  };
  ...
  window.HEALER_LOADOUT_CONFIG = {
    ...
    defaults: {
      ...
      sushia: { passive: "warmup", active: ["attack", "chacka"] },
