  ...
  window.HEALER_SKILL_DATA = {
    finald: {
      attack: {
        ...
        description: "１秒の詠唱を行った後、指定した範囲内の魔物に衝撃を与え、(式=値)の魔法ダメージを与える。",
        simpleDescription: "指定した範囲内の魔物に衝撃を与え、魔法ダメージを与える。",
      ...
      take_aim: {
        ...
        description: "指定した魔物1体を味方達が狙うようになる。15秒経過するか対象が戦闘不能になるまで続く。調子70%以上、もしくは30%以下の味方は70%の確率で無視する。",
        simpleDescription: "指定した魔物1体を一定時間、味方達が狙うようになる。",
      ...
      distance: {
        ...
        description: "８秒間、対象の魔物を味方がターゲットにしなくなる。範囲攻撃などの巻き込みは発生する。",
        simpleDescription: "一定時間、対象の魔物を味方が狙わなくなる。",
    ...
    ulpes: {
      ...
      heroSlash: {
        ...
        description: "広い範囲を薙ぎ払い、範囲内の魔物に(式=値)の物理ダメージを与える。命中した魔物の数が１体ごとにこのスキルのクールタイムを0.8秒短縮する。",
        simpleDescription: "広い範囲を薙ぎ払い、範囲内の魔物に物理ダメージを与える。命中した魔物の数によってこのスキルのクールタイムを短縮する。",
        upgradeSimpleDescription: "レベルが上がるごとにこのスキルが魔物に命中した際のクールタイムの短縮時間が増加する",
        upgradeDescription: "レベルが上がるごとにこのスキルが魔物に命中した際のクールタイム短縮時間が+(0.3/0.6/0.9/1.2/1.5)秒増加する",
      },
      sharpen_blade: {
      ...
      ult: {
        ...
        description: "0.7秒のチャージを行った後、最も距離が近い魔物の傍に移動し、対象の魔物１体に強力な斬撃をお見舞いし、(式=値)の物理ダメージを与える。",
        simpleDescription: "少しのチャージを行い、最も距離が近い魔物１体に強力な斬撃をお見舞いし、物理ダメージを与える。",
    ...
    rihas: {
      attack: {
        ...
        description: "周囲を振り払い、自身を中心とした一定範囲内の魔物に(式=値)の物理ダメージを与える。",
        simpleDescription: "周囲を振り払い、範囲内の魔物に物理ダメージを与える。",
        upgradeSimpleDescription: "レベルが上がるごとにダメージが上昇する",
        upgradeDescription: "レベルが上がるごとに基礎ダメージが(1.2/1.4/1.6/1.8/2.0)倍になる",
      },
      lan_wave: {
        ...
        description: "１秒のチャージを行った後、対象の魔物の傍にジャンプする。着地地点の周囲の魔物に(式=値)の物理ダメージを与える。さらに、広い範囲に(式=値)の魔法ダメージを与える衝撃波を放つ。",
        simpleDescription: "少しのチャージを行い、対象の魔物の傍にジャンプする。着地時の周囲の魔物に物理ダメージを与え、魔法ダメージを与える衝撃波を放つ。",
      ...
      ten_hit_combo: {
        ...
        description: "2秒の詠唱を行った後、魔物1体に10連撃をお見舞いし、(式=値)の物理ダメージを10回与える。",
        simpleDescription: "詠唱後、魔物1体に10連撃をお見舞いし物理ダメージを与える",
        upgradeSimpleDescription: "レベルが上がるごとにダメージが上昇する",
        upgradeDescription: "レベルが上がるごとに基礎ダメージが+(2/4/6/8/10)増加する",
      },
      full_power_attack: {
        id: "full_power_attack", key: "full_power_attack", owner: "rihas", name: "全力アタック", rank: "D", category: "スキル", skillType: "単体攻撃",
        requiredWeapons: ["拳具", "棒具"],
        cd: 28, cost: 0, cast: 1, range: px(70), damageBase: 20, attackScale: 1, scaleUpgradeMultipliers: [1, 1.1, 1.2, 1.3, 1.4, 1.5], lines: ["全力アタック"], damageType: "physical",
        formula: [{ text: "20 + 攻撃力 * 1", stat: "attack", baseProp: "damageBase", scaleProp: "attackScale" }],
        description: "指定した魔物１体を全力で攻撃し、(式=値)の物理ダメージを与える。",
        simpleDescription: "指定した魔物１体を全力で攻撃し、物理ダメージを与える。",
      ...
      mizootoshi: {
        ...
        description: "1秒のチャージを行った後、魔物の溝落を突き、(式=値)の物理ダメージを与え、3秒間の\"怯み\"を付与する",
        simpleDescription: "チャージ後、魔物の溝落を突き、\"怯み\"を付与する",
        upgradeSimpleDescription: "レベルが上がるごとにダメージが増加する",
        upgradeDescription: "レベルが上がるごとにこのスキルの参照式が(1.1/1.2/1.3/1.4/1.5)倍になる",
      },
      feet_hunt: {
        id: "feet_hunt", key: "feet_hunt", owner: "rihas", name: "足狩", rank: "D", category: "スキル", skillType: "単体攻撃",
        requiredWeapons: ["棒具", "片手剣", "両手剣"],
        cd: 32, cost: 0, range: px(80), damageBase: 10, attackScale: 0.4, flinchingDuration: 3, flinchingDurationPerLevel: 1, lines: ["足狩"], damageType: "physical", statusIds: ["debuff_flinching"],
        formula: [{ text: "10 + 攻撃力 * 0.4", stat: "attack", baseProp: "damageBase", scaleProp: "attackScale" }],
        description: "指定した魔物１体の足を攻撃し、(式=値)の物理ダメージを与え、3秒間の\"怯み\"を付与する。",
        simpleDescription: "指定した魔物の足を攻撃し、物理ダメージを与え、\"怯み\"を付与する。",
        upgradeSimpleDescription: "レベルが上がるごとに\"怯み\"の効果時間が増加する",
        upgradeDescription: "レベルが上がるごとに\"怯み\"の効果時間が+(1/2/3/4/5)秒増加する",
      },
      headbutt: {
        ...
        description: "魔物に強力な頭突きを放ち、(式=値)の物理ダメージを与える。相手の防御力の20%を無視する",
        simpleDescription: "魔物に強力な頭突きを放ち、物理ダメージを与える。相手の防御力を無視する",
        upgradeSimpleDescription: "レベルが上がるごとにダメージが増加する",
      ...
      ult: {
        ...
        description: "最大８体の周囲の魔物に\"挑発\"を付与する。挑発を与えた魔物１体につき、(式=値)のシールドを獲得する。",
        simpleDescription: "周囲の魔物に\"挑発\"を付与し、挑発を与えた魔物の数に応じてシールドを獲得する。",
    ...
    sushia: {
      attack: {
        ...
        description: "１秒の詠唱を行った後、魔力で生成した弾を発射する。当たった魔物に(式=値)の魔法ダメージを与える。魔力弾は魔物に当たるか最大射程まで飛ぶと消滅する。",
        simpleDescription: "詠唱後、魔力で生成された弾を発射する。",
        upgradeSimpleDescription: "レベルが上がるごとに魔力弾が魔物を貫通しやすくなる",
        upgradeDescription: "レベルが上がるごとに魔力弾が魔物を(1/2/3/4/5)体貫通するようになる",
      },
      bomb: {
        ...
        description: "３秒の詠唱を行った後、対象を中心とした一定範囲内の魔物に(式=値)の魔法ダメージを与える爆発を引き起こす。爆発の中心から離れているユニットほど受けるダメージが低下する。",
        simpleDescription: "詠唱後、対象を中心に周囲の魔物も巻き込む爆発を引き起こし、魔法ダメージを与える。中心から離れている魔物ほどダメージが低下する。",
      ...
      fire: {
        ...
        description: "１秒の詠唱を行った後、対象の魔物１体に炎を放ち、(式=値)の魔法ダメージを与え、3秒の\"燃焼\"を付与する。",
        simpleDescription: "詠唱後、対象の魔物１体に炎を放ち、魔法ダメージを与え、\"燃焼\"を付与する。",
        upgradeSimpleDescription: "レベルが上がるごとに付与する\"燃焼\"の効果時間が増加する",
        upgradeDescription: "レベルが上がるごとに付与する\"燃焼\"の効果時間が+(1/2/3/4/5)秒増加する",
      },
      walta: {
        id: "walta", key: "walta", owner: "sushia", name: "ウォルタ", rank: "D", category: "スキル", skillType: "単体攻撃",
        requiredWeapons: ["杖", "魔導書", "楽器"],
        cd: 14, cost: 40, range: px(400), cast: 1, damageBase: 30, magicScale: 0.45, leakageDuration: 3, leakageDurationPerLevel: 1, beamColor: "rgba(94,182,255,0.74)", burstRadius: px(44), lines: ["ウォルタ"], damageType: "magic", statusIds: ["debuff_leakage"],
        formula: [{ text: "30 + 魔力 * 0.45", stat: "magic", baseProp: "damageBase", scaleProp: "magicScale" }],
        description: "１秒の詠唱を行った後、対象の魔物１体に水を放ち、(式=値)の魔法ダメージを与え、3秒の\"漏水\"を付与する。",
        simpleDescription: "詠唱後、対象の魔物１体に水を放ち、魔法ダメージを与え、\"漏水\"を付与する。",
        upgradeSimpleDescription: "レベルが上がるごとに付与する\"漏水\"の効果時間が増加する",
        upgradeDescription: "レベルが上がるごとに付与する\"漏水\"の効果時間が+(1/2/3/4/5)秒増加する",
      },
      eleki: {
        id: "eleki", key: "eleki", owner: "sushia", name: "エレキ", rank: "D", category: "スキル", skillType: "単体攻撃",
        requiredWeapons: ["杖", "魔導書", "楽器"],
        cd: 14, cost: 40, range: px(400), cast: 1, damageBase: 30, magicScale: 0.45, tingleDuration: 3, tingleDurationPerLevel: 1, beamColor: "rgba(242,213,107,0.74)", burstRadius: px(44), lines: ["エレキ"], damageType: "magic", statusIds: ["debuff_tingle"],
        formula: [{ text: "30 + 魔力 * 0.45", stat: "magic", baseProp: "damageBase", scaleProp: "magicScale" }],
        description: "１秒の詠唱を行った後、対象の魔物１体に電気を放ち、(式=値)の魔法ダメージを与え、3秒の\"痺れ感\"を付与する。",
        simpleDescription: "詠唱後、対象の魔物１体に電気を放ち、魔法ダメージを与え、\"痺れ感\"を付与する。",
        upgradeSimpleDescription: "レベルが上がるごとに付与する\"痺れ感\"の効果時間が増加する",
      ...
      ice: {
        ...
        formula: [{ text: "30 + 魔力 * 0.45", stat: "magic", baseProp: "damageBase", scaleProp: "magicScale" }],
        description: "１秒の詠唱を行った後、対象の魔物１体に氷を放ち、(式=値)の魔法ダメージを与え、3秒の\"凍え\"を付与する。",
        simpleDescription: "詠唱後、対象の魔物１体に氷を放ち、魔法ダメージを与え、\"凍え\"を付与する。",
        upgradeSimpleDescription: "レベルが上がるごとに付与する\"凍え\"の効果時間が増加する",
        upgradeDescription: "レベルが上がるごとに付与する\"凍え\"の効果時間が+(1/2/3/4/5)秒増加する",
      },
      film_in: {
        id: "film_in", key: "film_in", owner: "sushia", name: "フィルム", rank: "D", category: "スキル", skillType: "単体バフ",
        requiredWeapons: ["杖", "魔導書", "楽器"],
        cd: 24, cost: 30, cast: 1, target: "ally", range: px(280), filmInDuration: 5, filmInDurationPerLevel: 1, lines: ["フィルム"], statusIds: ["buff_film_in"],
        description: "１秒の詠唱後、指定した味方に5秒間の\"被膜\"を付与する。",
        simpleDescription: "詠唱後、指定した味方に\"被膜\"を付与する。",
        upgradeSimpleDescription: "レベルが上がるごとに\"被膜\"の効果時間が増加する",
        upgradeDescription: "レベルが上がるごとに\"被膜\"の効果時間が+(1/2/3/4/5)秒増加する",
      },
      ult: {
        ...
        description: "５秒の詠唱を行った後、８秒の間、周囲の広い範囲を氷で覆いつくす。氷に触れた魔物には最大５秒の\"凍結\"を付与する。氷に触れている魔物は毎秒(式=値)の魔法ダメージを受け続ける。中心から離れている魔物ほどダメージと凍結の効果時間が弱くなる。",
        simpleDescription: "詠唱後、一定時間の間、周囲の広い範囲を氷で覆いつくす。氷に触れた魔物には\"凍結\"を付与する。氷に触れている魔物は魔法ダメージを受け続ける。中心から離れている魔物ほど効果が弱くなる。",
    ...
    weapon: {
      hornRabbitKnife: {
        ...
        description: "魔物に剣を突き刺し、(式=値)の物理ダメージを与える。",
        simpleDescription: "魔物に剣を突き刺し、物理ダメージを与える。",
        upgradeSimpleDescription: "レベルが上がるごとにダメージが上昇する",
      ...
      hornRabbitSword: {
        ...
        description: "1秒のチャージ後、魔物に剣を振りかざし、(式=値)の物理ダメージを与える。",
        simpleDescription: "少しのチャージを行い、魔物に剣を振りかざし、物理ダメージを与える。",
        upgradeSimpleDescription: "レベルが上がるごとにダメージが上昇する",
        upgradeDescription: "レベルが上がるごとにスキルの参照式が(1.1/1.2/1.3/1.4/1.5)倍になる",
      },
      hornRabbitFist: {
        ...
        description: "魔物の顔を殴り、(式=値)の物理ダメージを与える。",
        simpleDescription: "魔物の顔を殴り、物理ダメージを与える。",
        upgradeSimpleDescription: "レベルが上がるごとにダメージが上昇する",
        upgradeDescription: "レベルが上がるごとにスキルの参照式が(1.1/1.2/1.3/1.4/1.5)倍になる",
      },
      hornRabbitStaff: {
      ...
      hornRabbitStick: {
        ...
        description: "１秒の詠唱を行った後、指定した方向に魔力で生成した弾を発射する。当たった魔物に(式=値)の魔法ダメージを与える。魔力弾は魔物に当たるか最大射程まで飛ぶと消滅する。",
        simpleDescription: "詠唱後、魔力で生成された弾を発射する。",
        upgradeSimpleDescription: "レベルが上がるごとにダメージが上昇する",
        upgradeDescription: "レベルが上がるごとにスキルの参照式が(1.1/1.2/1.3/1.4/1.5)倍になる",
      },
      hornRabbitBook: {
        ...
        description: "1秒の詠唱後、指定した範囲内の魔物に衝撃を与え、(式=値)の魔法ダメージを与える。",
        simpleDescription: "詠唱後、指定した範囲内の魔物に衝撃を与え、魔法ダメージを与える。",
        upgradeSimpleDescription: "レベルが上がるごとにダメージが上昇する",
        upgradeDescription: "レベルが上がるごとにスキルの参照式が(1.1/1.2/1.3/1.4/1.5)倍になる",
      },
      hornRabbitFlute: {
        ...
        description: "詠唱後、周囲の魔物の魔力を中和し、4秒間対象の魔力を5%減少させる。",
        simpleDescription: "詠唱後、周囲の魔物の魔力を中和し、4秒間魔力を減少させる。",
      ...
      budAlrauneKnife: {
        ...
        description: "魔物に剣を突き刺し、(式=値)の物理ダメージを与える。20%の確率で魔物に3秒の\"睡眠\"を付与する。",
        simpleDescription: "魔物に剣を突き刺し、物理ダメージを与える。まれに魔物に\"睡眠\"を付与する。",
      ...
      budAlrauneSword: {
        ...
        description: "1秒のチャージ後、魔物に剣を振りかざし、(式=値)の物理ダメージを与える。20%の確率で魔物に3秒の\"睡眠\"を付与する。",
        simpleDescription: "少しのチャージを行い、魔物に剣を振りかざし、物理ダメージを与える。まれに\"睡眠\"を付与する。",
        upgradeSimpleDescription: "レベルが上がるごとに\"睡眠\"の付与率が上昇する",
        upgradeDescription: "レベルが上がるごとに\"睡眠\"の付与率が+(5/10/15/20/25)%上昇する",
      },
      budAlrauneFist: {
        ...
        description: "魔物の顔を殴り、(式=値)の物理ダメージを与える。20%の確率で魔物に3秒の\"睡眠\"を付与する。",
        simpleDescription: "魔物の顔を殴り、物理ダメージを与える。まれに\"睡眠\"を付与する。",
        upgradeSimpleDescription: "レベルが上がるごとに\"睡眠\"の付与率が上昇する",
        upgradeDescription: "レベルが上がるごとに\"睡眠\"の付与率が+(5/10/15/20/25)%上昇する",
      },
      budAlrauneStaff: {
        ...
        description: "棒具を振り、端を2回ずつ当て、(式=値)の物理ダメージを2度与える。20%ずつの確率で魔物に3秒の\"睡眠\"を付与する。1回目で\"睡眠\"を付与した場合、2回目のダメージが攻撃力 * 0.15分上昇し、この2回目では\"睡眠\"を付与しない。",
      ...
      budAlrauneStick: {
        ...
        description: "1秒の詠唱を行った後、指定した方向に魔力で生成した弾を発射する。当たった魔物に(式=値)の魔法ダメージを与える。魔力弾は魔物に当たるか最大射程まで飛ぶと消滅する。20%の確率で魔物に3秒の\"睡眠\"を付与する。",
      ...
      budAlrauneBook: {
        ...
        description: "1秒の詠唱後、指定した範囲内の魔物に衝撃を与え、(式=値)の魔法ダメージを与える。15%の確率で魔物に2秒の\"睡眠\"を付与する。",
        simpleDescription: "詠唱後、指定した範囲内の魔物に衝撃を与え、魔法ダメージを与える。まれに\"睡眠\"を付与する。",
        upgradeSimpleDescription: "レベルが上がるごとに\"睡眠\"の付与率が上昇する",
        upgradeDescription: "レベルが上がるごとに\"睡眠\"の付与率が+(5/10/15/20/25)%上昇する",
      },
      budAlrauneFlute: {
      ...
      shadowWolfKnife: {
        ...
        formula: [{ text: "13 + 攻撃力 * 0.5", stat: "attack", baseProp: "damageBase", scaleProp: "attackScale" }],
        description: "魔物に剣を突き刺し、(式=値)の物理ダメージを与え、3秒の\"負傷\"を付与する。",
        simpleDescription: "魔物に剣を突き刺し、物理ダメージを与え、\"負傷\"を付与する。",
      ...
      shadowWolfSword: {
        ...
        formula: [{ text: "10 + 攻撃力 * 0.6", stat: "attack", baseProp: "damageBase", scaleProp: "attackScale" }],
        description: "1秒のチャージ後、魔物に剣を振りかざし、(式=値)の物理ダメージを与え、3秒の\"負傷\"を付与する。",
        simpleDescription: "少しのチャージを行い、魔物に剣を振りかざし、物理ダメージを与え、\"負傷\"を付与する。",
        upgradeSimpleDescription: "レベルが上がるごとに\"負傷\"の効果時間が増加する",
        upgradeDescription: "レベルが上がるごとに\"負傷\"の効果時間が+(1/2/3/4/5)秒増加する",
      },
      shadowWolfFist: {
        ...
        formula: [{ text: "14 + 攻撃力 * 0.55", stat: "attack", baseProp: "damageBase", scaleProp: "attackScale" }],
        description: "魔物の顔を殴り、(式=値)の物理ダメージを与え、3秒の\"負傷\"を付与する。",
        simpleDescription: "魔物の顔を殴り、物理ダメージを与え、\"負傷\"を付与する。",
        upgradeSimpleDescription: "レベルが上がるごとに\"負傷\"の効果時間が増加する",
        upgradeDescription: "レベルが上がるごとに\"負傷\"の効果時間が+(1/2/3/4/5)秒増加する",
      },
      shadowWolfStaff: {
        ...
        formula: [{ text: "8 + 攻撃力 * 0.2", stat: "attack", baseProp: "damageBase", scaleProp: "attackScale" }],
        description: "棒具を振り、端を2回ずつ当て、(式=値)の物理ダメージを2度与える。命中した魔物に3秒の\"負傷\"を付与する。",
      ...
      flostinyKnife: {
        id: "flostiny_attack_knife", key: "flostinyKnife", owner: "weapon", name: "突き刺し", rank: "D", category: "通常攻撃", skillType: "単体攻撃",
        cd: 6, range: px(50), damageBase: 13, attackScale: 0.5, lifeStealRatio: 0.4, lifeStealMultiplierPerLevel: 0.1, lines: ["突き刺し"], damageType: "physical",
        formula: [{ text: "13 + 攻撃力 * 0.5", stat: "attack", baseProp: "damageBase", scaleProp: "attackScale" }],
        description: "魔物に剣を突き刺し、(式=値)の物理ダメージを与え、与えたダメージの40%分の体力を吸収する。",
        simpleDescription: "魔物に剣を突き刺し、物理ダメージを与え、体力を吸収する。",
        upgradeSimpleDescription: "レベルが上がるごとに体力の吸収量が増加する",
        upgradeDescription: "レベルが上がるごとに体力の吸収回復量が+(10/20/30/40/50)%増加する",
      },
      flostinySword: {
        id: "flostiny_attack_sword", key: "flostinySword", owner: "weapon", name: "振りかざし", rank: "D", category: "通常攻撃", skillType: "単体攻撃",
        cd: 6, cast: 1, range: px(65), damageBase: 10, attackScale: 0.6, lifeStealRatio: 0.4, lifeStealMultiplierPerLevel: 0.1, lines: ["振りかざし"], damageType: "physical",
        formula: [{ text: "10 + 攻撃力 * 0.6", stat: "attack", baseProp: "damageBase", scaleProp: "attackScale" }],
        description: "1秒のチャージ後、魔物に剣を振りかざし、(式=値)の物理ダメージを与え、与えたダメージの40%分の体力を吸収する。",
        simpleDescription: "少しのチャージを行い、魔物に剣を振りかざし、物理ダメージを与え、体力を吸収する。",
        upgradeSimpleDescription: "レベルが上がるごとに体力の吸収量が増加する",
        upgradeDescription: "レベルが上がるごとに体力の吸収回復量が+(10/20/30/40/50)%増加する",
      },
      flostinyFist: {
        id: "flostiny_attack_fist", key: "flostinyFist", owner: "weapon", name: "顔面パンチ", rank: "D", category: "通常攻撃", skillType: "単体攻撃",
        cd: 6, range: px(40), damageBase: 14, attackScale: 0.55, lifeStealRatio: 0.4, lifeStealMultiplierPerLevel: 0.1, lines: ["顔面パンチ"], damageType: "physical",
        formula: [{ text: "14 + 攻撃力 * 0.55", stat: "attack", baseProp: "damageBase", scaleProp: "attackScale" }],
        description: "魔物の顔を殴り、(式=値)の物理ダメージを与え、与えたダメージの40%分の体力を吸収する。",
        simpleDescription: "魔物の顔を殴り、物理ダメージを与え、体力を吸収する。",
        upgradeSimpleDescription: "レベルが上がるごとに体力の吸収量が増加する",
        upgradeDescription: "レベルが上がるごとに体力の吸収回復量が+(10/20/30/40/50)%増加する",
      },
      flostinyStaff: {
        id: "flostiny_attack_staff", key: "flostinyStaff", owner: "weapon", name: "2連打撃", rank: "D", category: "通常攻撃", skillType: "単体攻撃",
        cd: 6, range: px(55), hitRange: px(65), repeat: 2, repeatDelayMs: 120, damageBase: 8, attackScale: 0.2, lifeStealRatio: 0.4, lifeStealMultiplierPerLevel: 0.1, lines: ["2連打撃"], damageType: "physical",
        formula: [{ text: "8 + 攻撃力 * 0.2", stat: "attack", baseProp: "damageBase", scaleProp: "attackScale" }],
        description: "棒具を振り、端を1回ずつ当て、(式=値)の物理ダメージを2度与え、与えたダメージの40%分の体力を吸収する。",
        simpleDescription: "棒具を振り、端を1回ずつ当て、物理ダメージを与え、体力を吸収する。",
        upgradeSimpleDescription: "レベルが上がるごとに体力の吸収量が増加する",
        upgradeDescription: "レベルが上がるごとに体力の吸収回復量が+(10/20/30/40/50)%増加する",
      },
      flostinyStick: {
        id: "flostiny_attack_stick", key: "flostinyStick", owner: "weapon", name: "魔力弾", rank: "D", category: "通常攻撃", skillType: "方向指定攻撃",
        cd: 6, cost: 25, range: px(350), cast: 1, projectileCount: 1, spread: 0, lineWidth: px(12), projectileSpeed: px(360), projectileRadius: px(5), damageBase: 10, magicScale: 0.5, mpRestoreOnHit: 15, mpRestoreOnHitPerLevel: 5, life: rangeLife(350, 360), color: "#d9afff", lines: ["魔力弾"], damageType: "magic",
        formula: [{ text: "10 + 魔力 * 0.5", stat: "magic", baseProp: "damageBase", scaleProp: "magicScale" }],
        description: "１秒の詠唱を行った後、指定した方向に魔力で生成した弾を発射する。当たった魔物に(式=値)の魔法ダメージを与える。魔力弾が魔物に命中した場合、MPを15回復する。",
        simpleDescription: "詠唱後、魔力で生成された弾を発射し、命中した魔物に魔法ダメージを与える。魔物に命中した時MPを回復する。",
        upgradeSimpleDescription: "レベルが上がるごとにMPの回復量が増加する",
        upgradeDescription: "レベルが上がるごとにMPの回復量が+(5/10/15/20/25)増加する",
      },
      flostinyBook: {
        id: "flostiny_attack_book", key: "flostinyBook", owner: "weapon", name: "ショック", rank: "D", category: "通常攻撃", skillType: "範囲攻撃",
        cd: 6, cost: 20, range: px(230), radius: px(60), radiusPerLevel: px(6), burstRadius: px(68), cast: 1, damageBase: 10, magicScale: 0.35, mpRestorePerEnemyHit: 5, color: "#9ef7ff", lines: ["ショック"], damageType: "magic",
        formula: [{ text: "10 + 魔力 * 0.35", stat: "magic", baseProp: "damageBase", scaleProp: "magicScale" }],
        description: "1秒の詠唱後、指定した範囲内の魔物に衝撃を与え、(式=値)の魔法ダメージを与える。魔物に命中した数1体につきMPを5回復する。",
        simpleDescription: "詠唱後、指定した範囲内の魔物に衝撃を与え、魔法ダメージを与える。魔物に命中した数に応じてMPを回復する。",
        upgradeSimpleDescription: "レベルが上がるごとにスキルの範囲が増加する",
        upgradeDescription: "レベルが上がるごとにスキルの範囲が+(6/12/18/24/30)px増加する",
      },
      flostinyFlute: {
        id: "flostiny_attack_flute", key: "flostinyFlute", owner: "weapon", name: "予知の音", rank: "D", category: "通常攻撃", skillType: "範囲バフ",
        cd: 20, cost: 25, range: px(0), radius: px(220), burstRadius: px(228), cast: 0.5, center: "self", arcDeg: 40, arcDegPerLevel: 10, feelDuration: 5, lines: ["予知の音"], statusIds: ["buff_feel"],
        description: "0.5秒の詠唱後、範囲内の味方に5秒の\"フィール\"を付与する。",
        simpleDescription: "詠唱後、範囲内の味方に\"フィール\"を付与する。",
        upgradeSimpleDescription: "レベルが上がるごとにスキルの範囲が拡大する",
        upgradeDescription: "レベルが上がるごとにスキルの範囲が+(10/20/30/40/50)度拡大する",
      },
    },
    enemy: {
      ...
      vine_whip: {
        ...
        cd: 13, range: px(150), damageBase: 15, attackScale: 0.4, damageType: "physical", lines: ["ツル鞭"],
      },
      poisonous_stinger: {
      ...
      sowing_seeds: {
        ...
        cd: 40, range: px(0), radius: px(700), damageBase: 5, attackScale: 0.1, enemyArea: true, plantApply: true, plantNoOverwrite: true, damageType: "physical", lines: ["種まき"], statusIds: ["debuff_plant"],
      },
      welcome_rain: {
  ...
  window.HEALER_PASSIVE_DATA = {
    ...
    rihas: {
      ...
      gouken: {
        ...
        description: "魔物に3回物理ダメージを与えるたびに6秒の\"睡眠\"を付与する。",
        simpleDescription: "魔物に物理ダメージを与え続けると\"睡眠\"を付与する。",
      },
    },
    sushia: {
      warmup: { id: "warmup_passive", key: "warmup", owner: "sushia", name: "あったまってきたよ！", statusIds: ["buff_warmup"], description: "魔物に魔法ダメージを与えるたびに８秒間持続する\"ウォームアップ\"を１スタック獲得する。", simpleDescription: "魔物に魔法ダメージを与えるたびに\"ウォームアップ\"を獲得する。" },
      magic_add_on: {
