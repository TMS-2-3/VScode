  ...
  window.HEALER_SKILL_DATA = {
    ...
    rihas: {
      ...
      full_power_attack: {
        ...
        description: "指定した敵１体を全力で攻撃し、(式=値)の物理ダメージを与える。",
        simpleDescription: "指定した敵１体を全力で攻撃し、物理ダメージを与える。",
      ...
      feet_hunt: {
        ...
        description: "指定した敵１体の足を攻撃し、(式=値)の物理ダメージを与え、3秒間の\"怯み\"を付与する。",
        simpleDescription: "指定した敵の足を攻撃し、物理ダメージを与え、\"怯み\"を付与する。",
    ...
    sushia: {
      ...
      walta: {
        ...
        formula: [{ text: "30 + 魔力 * 0.45", stat: "magic", baseProp: "damageBase", scaleProp: "magicScale" }],
        description: "１秒の詠唱を行った後、対象の敵１体に水を放ち、(式=値)の魔法ダメージを与え、3秒の\"漏水\"を付与する。",
        simpleDescription: "詠唱後、対象の敵１体に水を放ち、魔法ダメージを与え、\"漏水\"を付与する。",
      ...
      eleki: {
        ...
        formula: [{ text: "30 + 魔力 * 0.45", stat: "magic", baseProp: "damageBase", scaleProp: "magicScale" }],
        description: "１秒の詠唱を行った後、対象の敵１体に電気を放ち、(式=値)の魔法ダメージを与え、3秒の\"痺れ感\"を付与する。",
        simpleDescription: "詠唱後、対象の敵１体に電気を放ち、魔法ダメージを与え、\"痺れ感\"を付与する。",
    ...
    weapon: {
      ...
      flostinyKnife: {
        ...
        formula: [{ text: "13 + 攻撃力 * 0.5", stat: "attack", baseProp: "damageBase", scaleProp: "attackScale" }],
        description: "敵に剣を突き刺し、(式=値)の物理ダメージを与え、与えたダメージの40%分の体力を吸収する。",
        simpleDescription: "敵に剣を突き刺し、物理ダメージを与え、体力を吸収する。",
      ...
      flostinySword: {
        ...
        formula: [{ text: "10 + 攻撃力 * 0.6", stat: "attack", baseProp: "damageBase", scaleProp: "attackScale" }],
        description: "1秒のチャージ後、敵に剣を振りかざし、(式=値)の物理ダメージを与え、与えたダメージの40%分の体力を吸収する。",
        simpleDescription: "少しのチャージを行い、敵に剣を振りかざし、物理ダメージを与え、体力を吸収する。",
        upgradeSimpleDescription: "レベルが上がるごとに体力の吸収量が増加する",
        upgradeDescription: "レベルが上がるごとに体力の吸収回復量が+(10/20/30/40/50)%増加する",
      },
      flostinyFist: {
        ...
        formula: [{ text: "14 + 攻撃力 * 0.55", stat: "attack", baseProp: "damageBase", scaleProp: "attackScale" }],
        description: "敵の顔を殴り、(式=値)の物理ダメージを与え、与えたダメージの40%分の体力を吸収する。",
        simpleDescription: "敵の顔を殴り、物理ダメージを与え、体力を吸収する。",
        upgradeSimpleDescription: "レベルが上がるごとに体力の吸収量が増加する",
        upgradeDescription: "レベルが上がるごとに体力の吸収回復量が+(10/20/30/40/50)%増加する",
      },
      flostinyStaff: {
      ...
      flostinyStick: {
        ...
        formula: [{ text: "10 + 魔力 * 0.5", stat: "magic", baseProp: "damageBase", scaleProp: "magicScale" }],
        description: "１秒の詠唱を行った後、指定した方向に魔力で生成した弾を発射する。当たった敵に(式=値)の魔法ダメージを与える。魔力弾が敵に命中した場合、MPを15回復する。",
        simpleDescription: "詠唱後、魔力で生成された弾を発射し、命中した敵に魔法ダメージを与える。敵に命中した時MPを回復する。",
      ...
      flostinyBook: {
        ...
        formula: [{ text: "10 + 魔力 * 0.35", stat: "magic", baseProp: "damageBase", scaleProp: "magicScale" }],
        description: "1秒の詠唱後、指定した範囲内の敵に衝撃を与え、(式=値)の魔法ダメージを与える。敵に命中した数1体につきMPを5回復する。",
        simpleDescription: "詠唱後、指定した範囲内の敵に衝撃を与え、魔法ダメージを与える。敵に命中した数に応じてMPを回復する。",
