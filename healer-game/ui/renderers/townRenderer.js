(() => {
  ...
  function hasTownStoryEventActors(eventActors) {
    return Boolean(town && town.story && Array.isArray(town.story.eventActors) && eventActors.length > 0);
  }
  ...
  function drawTownCharacters() {
    ...
    if (hasTownStoryEventActors(eventActors)) {
